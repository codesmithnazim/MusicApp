...
function ThemeTogglingBtn() {
  ...
  return (
    <div
      className={`${isDark ? "dark" : ""} text-foreground  bg-background  hover:bg-hbackground flex justify-start items-center gap-2 py-1 px-2 pl-1 rounded-md text-[12px] font-medium transition-colors `}
    >
      <button
